      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Sinh viên <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="index.php?controller=topic">Đăng ký đề tài</a></li>
                <li><a href="index.php?controller=list_topic">Sinh viên làm đề tài</a></li>
              </ul>
            </li>
            <li class="dropdown">
