	...
	*/
	class controller_faculty_upload_excel extends controller
	{
		...
		public function send_mail($username,$pass,$email)
		{
			...
			$mail->MsgHTML("Username: " . $username ."<br>"."Password: ". $pass . "<br>". "Bạn hãy truy cập vào link sau đăng nhập và cập nhật tài khoản: http://localhost/PTUDW/index.php"); //Nội dung của bức thư.
